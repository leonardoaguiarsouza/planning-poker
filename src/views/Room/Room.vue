  ...
  <div class="main">
    ...
    <div v-else>
      <nav>
        ...
        <ul>
          <li><a class="secondary">Tema escuro</a></li>
        </ul>
      </nav>
      <div class="play-field">
        <modal title="Digite seu nome" v-show="!playerNameFinal">
        ...
        <div class="room-controls">
          ...
          <button @click="editRoomConfigs">Configurações da Sala</button>
          <modal
            title="Configurações da sala"
            v-show="isEditRoomConfigsModalOpen"
          >
            <form @submit.prevent="createPlayer" v-if="!playerNameFinal">
              <input
                type="text"
...
const isEditRoomConfigsModalOpen = ref(false);
...
const editRoomConfigs = () => {
  isEditRoomConfigsModalOpen.value = true;
};
